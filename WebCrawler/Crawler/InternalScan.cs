...
namespace WebCrawler.Crawler
{
    ...
    internal class InternalScan : CommonMethods, IScanner
    {
        ...
        public InternalScan(string Url, int AmountOfTasks) //2021112202
        {
            MainUrl = Url;
        ...
        private void GetUrlsFromSourceCodeToQueue(string SourceCode, string ParentUrl)
        {
            ...
            if (vrDocument != null)
            {
                ...
                {
                    IEnumerable<string>? vrFiltredUrls = vrSelectedNodes
                        .Where(p => p != null)
                        ...
                        .Where(p => UrlOperations.DoTheyHaveSameHost(p, this.Host))
                        .Distinct(); //2021112236 - 2021112226
                    if (vrFiltredUrls != null)
                    {
        ...
        private void InitializeQueue()
        {
            ...
            if (vrQueue != null)
            {
                ...
                {
                    this.WaitingToScan.Enqueue(vrNode.Url);
                }
            }
        }
        public void Scanner()
